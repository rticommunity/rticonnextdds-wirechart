...
def main():
    configure_root_logger('./test_output/test.log', console_level=ALWAYS, file_level=logging.INFO)
    ...
    parser.add_argument("--pcap", type=str, default="", help="Test a single pcap file")
    args = parser.parse_args()

    test_files = []
    if args.pcap:
        test_files = [Path(args.pcap)]
    else:
