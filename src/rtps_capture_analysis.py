...
class RTPSCaptureAnalysis:
    ...
    def analyze_capture(self, capture: RTPSCapture):
        ...
        all_rows.extend(include_missing_topics_and_sm(self.df, capture.list_all_topics(), list_combinations_by_flag(SubmessageTypes.DISCOVERY, negate=True)))
        ...
        if DEV_DEBUG and not duplicates.empty:
